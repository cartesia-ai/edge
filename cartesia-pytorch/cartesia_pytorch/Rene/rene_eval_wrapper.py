...
To evaluate a Llamba-class model, pass `llamba_ssm` to the `--model` argument.
"""
...
class ReneLMWrapper(HFLM):
    ...
    def _get_config(self, pretrained: str, **kwargs) -> None:
        from Rene.configuration_rene import ReneConfig
    ...
    def _create_model(
        ...
        from Rene.rene import ReneLMHeadModel
