...
template <typename T>
[[kernel]] void ssd_update_no_z_kernel(
    // Input 
...
#define instantiate_ssd_update_no_z_kernel(type_name, type)      \
  template [[host_name("ssd_update_no_z_kernel_" #type_name)]]   \
  [[kernel]] void ssd_update_no_z_kernel<type>(                  \
...
instantiate_ssd_update_no_z_kernel(float32, float);
instantiate_ssd_update_no_z_kernel(float16, half);
