# Adapted from: https://github.com/ml-explore/mlx-examples/blob/main/llms/mlx_lm/sample_utils.py
...
@partial(mx.compile, inputs=mx.random.state, outputs=mx.random.state)
def categorical_sampling(logits, temperature=1.0):
    """Standard categorical_sampling."""
